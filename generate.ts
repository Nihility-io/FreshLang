...
const sHeader = (importName: string) =>
	`/* This file is autogenerated by ${importName}. DO NOT EDIT! */
import { helperTranslate, helperUseLanguage } from "${importName}"`

const sLanguage = (m: Record<string, Metadata>) => `
/**
...
const sTranslationsKey = (t: Record<string, string>) => `
/**
* List of all translated keys
*/
export type TranslationKey = \n${Record.mapToArray(t, (x) => `    | "${x}"`).join("\n")}`

const sUseLanguageEnum = `
/**
...
const sSupportedLanguages = (m: Record<string, Metadata>) => `
...
const sTranslations = (ts: Record<string, Record<string, string>>) => `
/**
...
const sTranslate = (m: Record<string, Metadata>, baseLanguage: string) => `
/**
