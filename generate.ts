...
import { helperTranslate, helperGetTranslation, helperUseLanguage, TrimPrefix, setLanguageMetadata } from "${importName}"`

const setMetadata = (m: Record<string, Metadata>): string => `
/** Register language metadata with the Fresh Plugin */
setLanguageMetadata(${JSON.stringify(m)})
`
